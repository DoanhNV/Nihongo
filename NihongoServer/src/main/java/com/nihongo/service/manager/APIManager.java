...
public class APIManager {
	...
	private static void initTokenAPIMap() {
		...
		tokenAPIs.put(MCQ_QUESTION.ROOT + MCQ_QUESTION.DELETE_DOCUMENT_QUESTION, true);
	...
	private static void initBackendAPIMap() {
		...
		backendAPIMap.put(MCQ_QUESTION.ROOT + MCQ_QUESTION.DELETE_DOCUMENT_QUESTION, true);
